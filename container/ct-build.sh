...
#
# gv-clade-index — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: clade-registry-api-release)
