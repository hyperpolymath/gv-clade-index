...
# gv-clade-index container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping clade-registry-api..."
...
echo "Starting clade-registry-api..."
echo "  Host: ${APP_HOST:-[::]}"
...
# Examples:
#   exec /app/clade-registry-api
#   exec /app/release/bin/clade-registry-api start
#   exec /app/clade-registry-api serve --host "${APP_HOST}" --port "${APP_PORT}"
